...
{pstd} Also, in contrast with {help xtqreg}, standard errors for quantiles, location and scale effects, adjust the degrees of freedom.
...
{pstd} I want to thank to J.M.C. Santos Silva for claryfing some of the details regarding the estimaton methodology. {p_end}
